...
def mainHelp():
    ...
    parser.add_argument(
        ...
        type=int,
        help=
        "Points required in a cluster, minPts in cDBSCAN, key parameter, default is 5. 5 is good for TFs and histone modification ChIA-PET data. For data like HiChIP, set it larger, like 10, 25, 50."
    )
    parser.add_argument(
        "-p",
        dest="cpu",
